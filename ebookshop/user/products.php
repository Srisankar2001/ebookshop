...
<div class="container-fluid welcome">
  <div class="d-flex">
    ...
    <h4><a href="products.php?logout"><i class="bi bi-box-arrow-left"></i>Logout</a></h4>
  </div>
</div> 
  ...
  <ul class="navbar-nav m-auto text-center">
    ...
    <?php
        ...
        while($row_genre = $result_genre->fetch_assoc()){
          ...
          <a href="products.php?genre='.$genre_id.'" class="nav-link">'.$genre_name.'</a>
          </li>';
        }
    ?>
  </ul>
...
<!-- item display -->
    <div class="col-md-10 justify-content-end">
          <div class="row">
            <?php
            if(!isset($_GET['genre'])){
              $select_book = "SELECT * FROM book order by rand()";
                ...
                while($row_book = $result_book->fetch_assoc()){
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                              ...
                              <a href="products.php?cart='.$book_id.'" class="btn btn-primary">Add to cart</a>
              ...
              $select_book = "SELECT * FROM book WHERE FIND_IN_SET('{$_GET["genre"]}', genre) order by rand()";
                $result_book = $con->query($select_book);
